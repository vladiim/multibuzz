...
class ConversionTest < ActiveSupport::TestCase
  ...
  test "should require non-negative revenue when present" do
    ...
    assert_predicate conversion, :valid?, "Zero revenue should be valid"
